...
static char const *__pyx_v_10helloworld_hello;
...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "helloworld")) {
      if (unlikely(PyDict_SetItemString(modules, "helloworld", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "helloworld.pyx":3
 * 
 * # This is how we can combine c code with python code
 * cdef const char *hello = "Hello world";             # <<<<<<<<<<<<<<
 * 
 * print(hello);
 */
  __pyx_v_10helloworld_hello = ((char const *)"Hello world");
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyBytes_FromString(__pyx_v_10helloworld_hello); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_PrintOne(0, __pyx_t_1) < 0) __PYX_ERR(0, 5, __pyx_L1_error)
